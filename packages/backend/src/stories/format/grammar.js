...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      {
        name: 'SCENE',
        symbols: ['SCENE$ebnf$1', 'SCENE$ebnf$2'],
        postprocess: toScene,
      },
      { name: 'PASSAGE$ebnf$1', symbols: [{ literal: '\n' }] },
      {
        name: 'PASSAGE$ebnf$1',
        symbols: ['PASSAGE$ebnf$1', { literal: '\n' }],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      ...
      {
        name: 'PASSAGE$ebnf$2',
        symbols: ['PASSAGE$ebnf$2', 'SENTENCE'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      {
        name: 'PASSAGE',
        symbols: ['HEADER', 'PASSAGE$ebnf$1', 'PASSAGE$ebnf$2'],
        postprocess: toPassage,
      },
      ...
      { name: 'SENTENCE$ebnf$1', symbols: [{ literal: '\n' }] },
      {
        ...
        symbols: ['SENTENCE$ebnf$1', { literal: '\n' }],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      {
        name: 'SENTENCE',
        symbols: ['SENTENCE$subexpression$1', 'SENTENCE$ebnf$1'],
        postprocess: toSentence,
      },
      ...
      {
        name: 'PLAIN_TEXT$ebnf$1',
        symbols: ['PLAIN_TEXT$ebnf$1$subexpression$1'],
      },
      ...
      {
        name: 'PLAIN_TEXT$ebnf$1',
        symbols: ['PLAIN_TEXT$ebnf$1', 'PLAIN_TEXT$ebnf$1$subexpression$2'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      ...
      {
        name: 'LINK_TEXT$ebnf$1',
        symbols: ['LINK_TEXT$ebnf$1$subexpression$1'],
      },
      { name: 'LINK_TEXT$ebnf$1$subexpression$2', symbols: ['ALPHANUMERIC'] },
      { name: 'LINK_TEXT$ebnf$1$subexpression$2', symbols: ['_'] },
      {
        name: 'LINK_TEXT$ebnf$1',
        symbols: ['LINK_TEXT$ebnf$1', 'LINK_TEXT$ebnf$1$subexpression$2'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      ...
      {
        name: 'LINK_TARGET$ebnf$1$subexpression$1',
        symbols: [{ literal: '-' }],
      },
      {
        name: 'LINK_TARGET$ebnf$1',
        symbols: ['LINK_TARGET$ebnf$1', 'LINK_TARGET$ebnf$1$subexpression$1'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      ...
      {
        name: 'LINK_TARGET$ebnf$2',
        symbols: ['LINK_TARGET$ebnf$2', 'ALPHANUMERIC'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      {
        name: 'LINK_TARGET',
        symbols: ['ALPHANUMERIC', 'LINK_TARGET$ebnf$1', 'LINK_TARGET$ebnf$2'],
        postprocess: (tokens) => flatten(tokens).join(''),
      },
      ...
      {
        name: 'HEADER$ebnf$2$subexpression$1',
        symbols: [{ literal: '|' }, 'HEADER_NAME'],
      },
      {
        name: 'HEADER$ebnf$2',
        symbols: ['HEADER$ebnf$2', 'HEADER$ebnf$2$subexpression$1'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
      {
        name: 'HEADER',
        symbols: [{ literal: '#' }, 'HEADER$ebnf$1', 'HEADER$ebnf$2'],
        postprocess: toHeader,
      },
      { name: 'HEADER_NAME$ebnf$1$subexpression$1', symbols: ['ALPHANUMERIC'] },
      {
        name: 'HEADER_NAME$ebnf$1$subexpression$1',
        symbols: [{ literal: '-' }],
      },
      { name: 'HEADER_NAME$ebnf$1$subexpression$1', symbols: ['_'] },
      {
        name: 'HEADER_NAME$ebnf$1',
        symbols: ['HEADER_NAME$ebnf$1$subexpression$1'],
      },
      { name: 'HEADER_NAME$ebnf$1$subexpression$2', symbols: ['ALPHANUMERIC'] },
      {
        name: 'HEADER_NAME$ebnf$1$subexpression$2',
        symbols: [{ literal: '-' }],
      },
      { name: 'HEADER_NAME$ebnf$1$subexpression$2', symbols: ['_'] },
      {
        name: 'HEADER_NAME$ebnf$1',
        symbols: ['HEADER_NAME$ebnf$1', 'HEADER_NAME$ebnf$1$subexpression$2'],
        postprocess: function arrpush(d) {
          return d[0].concat([d[1]]);
        },
      },
